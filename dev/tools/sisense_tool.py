...
@tool
def query_sisense_datasource(query: str, datasource: str = "C4R_CM_Project_Data_Check_DEV") -> str:
    """
    This function return short description for projects - start date, end date, project name and project id.
