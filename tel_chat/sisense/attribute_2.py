...
@tool
def attribute_2(query: str, datasource: str = "C4R_CM_Project_Data_Check_DEV") -> str:
    """
    This function return table for 'Attribute 2' with list of main feature, total counts of UPC_ID for each feature, Total Sales and Total Units and its share.
    It should be used analyze different features of 'Attribute 2'.
