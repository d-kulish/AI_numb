...
@tool
def price_segments(query: str, datasource: str = "C4R_CM_Project_Data_Check_DEV") -> str:
    """
    This function return table for 'Price segments' with list of main feature, total counts of UPC_ID for each feature, Total Sales and Total Units and its share.
    It should be used analyze different segments of price groups.
    ...
    query = f"""SELECT 
        "Price segment" as "Price segment", 
    ...
    if stores_df is not None:
        ...
        stores_df["Price segment"] = stores_df["Price segment"].replace({
            "2_Medium": "Medium",
            "3_High": "High", 
            "1_Low": "Low",
            "4_Premium": "Premium",
