...
@tool
def brand(query: str, datasource: str = "C4R_CM_Project_Data_Check_DEV") -> str:
    """
    This function return table for 'Brand' with list of main feature, total counts of UPC_ID for each feature, Total Sales and Total Units and its share.
    It should be used analyze different features of 'Brand'.
    ...
    if stores_df is not None:
        ...
        filtered_df = stores_df[stores_df["UPC Share (%)"] > 2]
