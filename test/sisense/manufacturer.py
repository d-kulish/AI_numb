...
@tool
def manufacturer(query: str, datasource: str = "C4R_CM_Project_Data_Check_DEV") -> str:
    """
    This function return table for 'Manufacturer' with list of main feature, total counts of UPC_ID for each feature, Total Sales and Total Units and its share.
    It should be used analyze different features of 'Manufacturer'.
    ...
    query = f"""SELECT 
        Main_manufacturer as "Manufacturer", 
    ...
    if stores_df is not None:
        ...
        filtered_df = stores_df[stores_df["Sales Share (%)"] > 1]
        ...
        result = pd.concat([filtered_df, totals])
